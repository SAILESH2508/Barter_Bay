        ...
        <?php foreach ($products as $product): ?>
            ...
            <h3><?php echo htmlspecialchars($product['name']); ?></h3>
                ...
                <form method="POST" action="trade_process.php">
                    ...
                    <input type="hidden" name="receiver_id" value="<?php echo intval($product['user_id']); ?>">
                    <input type="hidden" name="receiver_product_id" value="<?php echo intval($product['id']); ?>">
                    ...
                    <select name="sender_product_id" required>
                        ...
                        <?php foreach ($my_products as $my): ?>
                            <option value="<?php echo intval($my['id']); ?>">
